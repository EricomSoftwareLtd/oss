...
func (dlg *EditDialog) onConfigEdited(newConfig *conf.Config) {

	// saving [Config] section
	dlg.config.Name = newConfig.Name
	dlg.config.Interface = newConfig.Interface
	dlg.config.Peers = newConfig.Peers
}
