...
func RunUI() {
	...
	if shouldQuitManagerWhenExiting {
		...
		if err != nil {
			showErrorCustom(nil, l18n.Sprintf("Error Exiting ZTEdge Client"), l18n.Sprintf("Unable to exit service due to: %v. You may want to stop ZTEdge Client from the service manager.", err))
		}
	}
}
