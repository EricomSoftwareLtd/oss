...
func permitWireGuardService(session uintptr, baseObjects *baseObjects, weight uint8) error {
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted outbound traffic for ZTEdge Client service (IPv4)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted inbound traffic for ZTEdge Client service (IPv4)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted outbound traffic for ZTEdge Client service (IPv6)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted inbound traffic for ZTEdge Client service (IPv6)", "")
		if err != nil {
			return wrapErr(err)
		}
