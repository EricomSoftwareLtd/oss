...
[Config]
host = multi-factor-auth-3.zerotrustedge.com:8444
key = hLY88mXAJhDIvhvuZNZUxrVVtUnQoQWGtEzkCvqBu2w=
...
func TestFromOldWgQuick(t *testing.T) {
	conf, err := FromWgQuick(testInputOldConfig, "test")
	if noError(t, err) {
