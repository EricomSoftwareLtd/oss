...
public final class Config {
    ...
    private Config(final Builder builder) {
        activationData = builder.activationData;
    ...
    public static Config parse(final BufferedReader reader)
        ...
        while ((line = reader.readLine()) != null) {
            ...
            } else if (inActivationDataSection) {
                activationDataLines.add(line);
        ...
        builder.parseActivationData(activationDataLines);
    ...
    public boolean equals(final Object obj) {
        ...
        return interfaze.equals(other.interfaze) && peers.equals(other.peers) && activationData.equals(other.activationData);
    }
    ...
    public String toZTEConfigString() {
        final StringBuilder sb = new StringBuilder();
    ...
    public static final class Builder {
        ...
        @Nullable private ActivationData activationData;

        public Builder setActivationData(final ActivationData activationData) {
        ...
        public Builder parseActivationData(final Iterable<? extends CharSequence> lines)
                throws BadConfigException {
            return setActivationData(ActivationData.parse(lines));
        }
