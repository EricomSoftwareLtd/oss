...
package com.ericom.ztac.preference
...
import com.ericom.ztac.util.AdminKnobs
import com.ericom.ztac.util.BiometricAuthenticator
import com.ericom.ztac.util.DownloadsFileSaver
import com.ericom.ztac.util.ErrorMessages
import com.ericom.ztac.util.activity
import com.ericom.ztac.util.lifecycleScope
        ...
        lifecycleScope.launch {
            ...
            try {
                exportedFilePath = withContext(Dispatchers.IO) {
                    ...
                    val outputFile = downloadsFileSaver.save("ztedge-export.zip", "application/zip", true)
                    if (outputFile == null) {
