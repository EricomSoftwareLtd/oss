...
import com.ericom.ztac.BuildConfig
import com.ericom.ztac.R
import com.ericom.ztac.databinding.LogViewerActivityBinding
...
class LogViewerActivity : AppCompatActivity() {
    ...
    private suspend fun saveLog() {
        ...
        withContext(Dispatchers.IO) {
            try {
                outputFile = downloadsFileSaver.save("EricomZTE-log.txt", "text/plain", true)
