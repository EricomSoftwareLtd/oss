...
extension TunnelConfiguration.ParseError: WireGuardAppError {
    var alertText: AlertText {
        ...
        case .configHasNotHostKey:
            return (tr("configHasNotHostKey"), "configHasNotHostKeyText")
        case .configHasNotPublicKey:
            return (tr("configHasNotPublicKey"), "configHasNotPublicKeyText")
        case .configHasUnrecognizedKey(let value):
            return (tr(format: "macAlertUnrecognizedConfigKey (%@)", value), tr("macInfoUnrecognizedConfigKey"))
        }
    }
}
