...
class Keychain {
    ...
    static func makeReference(containing value: String, called name: String, previouslyReferencedBy oldRef: Data? = nil) -> Data? {
        ...
        let itemLabel = "ZTEdge tunnel: \(name)"
        ...
        guard let extensionPath = Bundle.main.builtInPlugInsURL?.appendingPathComponent("ZTENetworkExtension.appex", isDirectory: true).path else {
